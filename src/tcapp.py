...
def write():
    st.subheader("Example traffic grid")
    ...
    st.write(grid.graph())
    st.subheader("Mesh Grid")
    st.write(grid.meshgrid())
'''

############## QISKIT PART ###############
# Build Discriminator for |1> & |2> states with pulse
# Source: IBM Accessing Higher Energy States
